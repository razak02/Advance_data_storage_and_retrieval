...
def welcome():
   ...
   <a href="/api/v1.0/stations">/api/v1.0/stations</a>
    ...
    <br>
    <li>
    Return a JSON list of Temperature Observations (tobs) a year from last data point:
    <br>
    <a href="/api/v1.0/tobs">/api/v1.0/tobs</a>
    </li>
    <br>
    <li>
    Return a JSON list of tmin, tmax, tavg for the dates greater than or equal for date provided:
    ...
    <br>
    <br>
    <a href="/api/v1.0/2017-08-23/2017-08-23">/api/v1.0/2017-08-15/2017-08-23</a>
    </li>
    <br>
    </ul>
    </html>
